...
import com.example.epaycosdk.databinding.AddNewDefaultTokenkFragmentBinding
import com.example.epaycosdk.ui.slideshow.SlideshowViewModel
import org.json.JSONException
import org.json.JSONObject
import java.lang.Exception

class AddNewDefaultTokenkFragment : PrincipalFragment() {

    private lateinit var viewModel: AddNewDefaultTokenkViewModel
    private var _binding: AddNewDefaultTokenkFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        viewModel =
            ViewModelProvider(this).get(AddNewDefaultTokenkViewModel::class.java)
        val epayco = Epayco(auth)
        val client = Client()

        _binding = AddNewDefaultTokenkFragmentBinding.inflate(inflater, container, false)
        ...
        btn_submit.setOnClickListener {
            ...
            epayco.addTokenDefault(client, object : EpaycoCallback {
